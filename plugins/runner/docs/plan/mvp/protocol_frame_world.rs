  ...
  pub mod ntx {
    pub mod runner {
      ...
      pub mod protocol_frame {
        ...
        pub type UserStoreEntry = super::super::super::super::ntx::runner::types::UserStoreEntry;
        pub type UserId = super::super::super::super::ntx::runner::types::UserId;

        #[derive(Debug)]
        #[repr(transparent)]
        pub struct Frame{
          handle: _rt::Resource<Frame>,
        }

        type _FrameRep<T> = Option<T>;
        ...
        impl Frame{
          ...
          /// create a handle. The owned handle is then returned as `Frame`.
          pub fn new<T: GuestFrame>(val: T) -> Self {
            Self::type_guard::<T>();
            let val: _FrameRep<T> = Some(val);
            let ptr: *mut _FrameRep<T> =
          ...
          pub fn get<T: GuestFrame>(&self) -> &T {
          ...
          /// resource.
          pub fn get_mut<T: GuestFrame>(&mut self) -> &mut T {
            let ptr = unsafe { &mut *self.as_ptr::<T>() };
            ptr.as_mut().unwrap()
          }

          /// Consumes this resource and returns the underlying `T`.
          pub fn into_inner<T: GuestFrame>(self) -> T {
            let ptr = unsafe { &mut *self.as_ptr::<T>() };
            ptr.take().unwrap()
          }
          ...
          // It's theoretically possible to implement the `GuestFrame` trait twice
          ...
          pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
            Self::type_guard::<T>();
            let _ = unsafe { _rt::Box::from_raw(handle as *mut _FrameRep<T>) };
          }

          fn as_ptr<T: GuestFrame>(&self) -> *mut _FrameRep<T> {
            Frame::type_guard::<T>();
            T::_resource_rep(self.handle()).cast()
          }
        }

        /// A borrowed version of [`Frame`] which represents a borrowed value
        /// with the lifetime `'a`.
        #[derive(Debug)]
        #[repr(transparent)]
        pub struct FrameBorrow<'a> {
          rep: *mut u8,
          _marker: core::marker::PhantomData<&'a Frame>,
        }

        impl<'a> FrameBorrow<'a>{
          #[doc(hidden)]
          ...
          pub fn get<T: GuestFrame>(&self) -> &'a T {
            let ptr = unsafe { &mut *self.as_ptr::<T>() };
            ptr.as_ref().unwrap()
          }
          ...
          fn as_ptr<T: 'static>(&self) -> *mut _FrameRep<T> {
            Frame::type_guard::<T>();
            self.rep.cast()
          }
        }
        ...
        unsafe impl _rt::WasmResource for Frame{
          #[inline]
          unsafe fn drop(_handle: u32) {
            
            #[cfg(target_arch = "wasm32")]
            #[link(wasm_import_module = "[export]ntx:runner/protocol-frame")]
            unsafe extern "C" {
              #[link_name = "[resource-drop]frame"]
              fn drop(_: i32, );
            }
        ...
        pub unsafe fn _export_init_cabi<T: Guest>(arg0: *mut u8,arg1: usize,arg2: *mut u8,arg3: usize,arg4: *mut u8,arg5: usize,arg6: *mut u8,arg7: usize,arg8: i32,arg9: *mut u8,arg10: usize,) -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
        _rt::run_ctors_once();let result19 = {
          let len0 = arg1;
          ...
          for i in 0..len18 {
            let base = base18.add(i * (9*::core::mem::size_of::<*const u8>()));
            let e18 = {
              ...
              let l11 = i32::from(*base.add(4*::core::mem::size_of::<*const u8>()).cast::<u8>());
              let l12 = i32::from(*base.add(1+4*::core::mem::size_of::<*const u8>()).cast::<u8>());
              let l13 = i32::from(*base.add(5*::core::mem::size_of::<*const u8>()).cast::<u8>());
              let l17 = i32::from(*base.add(8*::core::mem::size_of::<*const u8>()).cast::<u8>());

              super::super::super::super::ntx::runner::types::TaskMeta{
                task_id: _rt::string_lift(bytes7),
                workflow_id: _rt::string_lift(bytes10),
                protocol: super::super::super::super::ntx::runner::types::ProtocolKind::_lift(l11 as u8),
                priority: l12 as u8,
                template_ref: match l13 {
                  0 => None,
                  1 => {
                    let e = {
                      let l14 = *base.add(6*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                      let l15 = *base.add(7*::core::mem::size_of::<*const u8>()).cast::<usize>();
                      let len16 = l15;
                ...
                origin: super::super::super::super::ntx::runner::types::ActionOrigin::_lift(l17 as u8),
              }
            };
            result18.push(e18);
          }
          _rt::cabi_dealloc(base18, len18 * (9*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>());
        ...
        match result19 {
          Ok(e) => { {
            ...
            *ptr20.add(::core::mem::size_of::<*const u8>()).cast::<i32>() = (e).take_handle() as i32;
          } },
          Err(e) => { {
            *ptr20.add(0).cast::<u8>() = (1i32) as u8;
            let super::super::super::super::ntx::runner::types::PfError{ kind:kind21, message:message21, } = e;
            *ptr20.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (kind21.clone() as i32) as u8;
            let vec22 = (message21.into_bytes()).into_boxed_slice();
            let ptr22 = vec22.as_ptr().cast::<u8>();
            let len22 = vec22.len();
            ::core::mem::forget(vec22);
            *ptr20.add(3*::core::mem::size_of::<*const u8>()).cast::<usize>() = len22;
            *ptr20.add(2*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr22.cast_mut();
          } },
        };ptr20
      } }
      #[doc(hidden)]
      ...
      #[doc(hidden)]
      #[allow(non_snake_case, unused_unsafe)]
      pub unsafe fn _export_claim_cabi<T: Guest>(arg0: i32,) -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
      _rt::run_ctors_once();let result0 = {
        T::claim(FrameBorrow::lift(arg0 as u32 as usize))
      };
      ...
      match result0 {
        Ok(e) => { {
          *ptr1.add(0).cast::<u8>() = (0i32) as u8;
              ...
              *ptr1.add(16+12*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr9.cast_mut();
              ...
              Err(e) => { {
                *ptr1.add(0).cast::<u8>() = (1i32) as u8;
                let super::super::super::super::ntx::runner::types::PfError{ kind:kind13, message:message13, } = e;
          ...
          #[doc(hidden)]
          #[allow(non_snake_case)]
          pub unsafe fn __post_return_claim<T: Guest>(arg0: *mut u8,) { unsafe {
            let l0 = i32::from(*arg0.add(0).cast::<u8>());
            match l0 {
              0 => {
          ...
          #[doc(hidden)]
          #[allow(non_snake_case, unused_unsafe)]
          pub unsafe fn _export_commit_cabi<T: Guest>(arg0: *mut u8,) -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
          _rt::run_ctors_once();let result45 = {
            ...
            T::commit(FrameBorrow::lift(l0 as u32 as usize), super::super::super::super::ntx::runner::types::ActionResult{
          ...
          match result45 {
            ...
            Err(e) => { {
              *ptr46.add(0).cast::<u8>() = (1i32) as u8;
              let super::super::super::super::ntx::runner::types::PfError{ kind:kind47, message:message47, } = e;
        ...
        #[doc(hidden)]
        #[allow(non_snake_case, unused_unsafe)]
        pub unsafe fn _export_store_user_cabi<T: Guest>(arg0: i32,arg1: *mut u8,arg2: usize,arg3: *mut u8,arg4: usize,arg5: i64,) -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
        _rt::run_ctors_once();let result2 = {
          let len0 = arg2;
          let bytes0 = _rt::Vec::from_raw_parts(arg1.cast(), len0, len0);
          let len1 = arg4;
          let bytes1 = _rt::Vec::from_raw_parts(arg3.cast(), len1, len1);
          T::store_user(FrameBorrow::lift(arg0 as u32 as usize), super::super::super::super::ntx::runner::types::UserStoreEntry{
            user_id: _rt::string_lift(bytes0),
            blob_path: _rt::string_lift(bytes1),
            updated_at_ns: arg5 as u64,
          })
        };
        ...
        match result2 {
          ...
          Err(e) => { {
            *ptr3.add(0).cast::<u8>() = (1i32) as u8;
            let super::super::super::super::ntx::runner::types::PfError{ kind:kind4, message:message4, } = e;
            *ptr3.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (kind4.clone() as i32) as u8;
      ...
      #[doc(hidden)]
      #[allow(non_snake_case)]
      pub unsafe fn __post_return_store_user<T: Guest>(arg0: *mut u8,) { unsafe {
        let l0 = i32::from(*arg0.add(0).cast::<u8>());
        match l0 {
          0 => (),
          _ => {
      ...
      #[doc(hidden)]
      #[allow(non_snake_case, unused_unsafe)]
      pub unsafe fn _export_load_user_cabi<T: Guest>(arg0: i32,arg1: *mut u8,arg2: usize,) -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
      _rt::run_ctors_once();let result1 = {
        let len0 = arg2;
        let bytes0 = _rt::Vec::from_raw_parts(arg1.cast(), len0, len0);
        T::load_user(FrameBorrow::lift(arg0 as u32 as usize), _rt::string_lift(bytes0))
      };
      let ptr2 = (&raw mut _RET_AREA.0).cast::<u8>();
      match result1 {
        Some(e) => {
          *ptr2.add(0).cast::<u8>() = (1i32) as u8;
          let super::super::super::super::ntx::runner::types::UserStoreEntry{ user_id:user_id3, blob_path:blob_path3, updated_at_ns:updated_at_ns3, } = e;
          let vec4 = (user_id3.into_bytes()).into_boxed_slice();
          let ptr4 = vec4.as_ptr().cast::<u8>();
          let len4 = vec4.len();
          ::core::mem::forget(vec4);
          *ptr2.add(8+1*::core::mem::size_of::<*const u8>()).cast::<usize>() = len4;
          *ptr2.add(8).cast::<*mut u8>() = ptr4.cast_mut();
          let vec5 = (blob_path3.into_bytes()).into_boxed_slice();
          let ptr5 = vec5.as_ptr().cast::<u8>();
          let len5 = vec5.len();
          ::core::mem::forget(vec5);
          *ptr2.add(8+3*::core::mem::size_of::<*const u8>()).cast::<usize>() = len5;
          *ptr2.add(8+2*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr5.cast_mut();
    ...
    #[doc(hidden)]
    #[allow(non_snake_case)]
    pub unsafe fn __post_return_load_user<T: Guest>(arg0: *mut u8,) { unsafe {
      let l0 = i32::from(*arg0.add(0).cast::<u8>());
      match l0 {
        0 => (),
        _ => {
    ...
    #[doc(hidden)]
    #[allow(non_snake_case, unused_unsafe)]
    pub unsafe fn _export_request_task_cabi<T: Guest>(arg0: i32,arg1: *mut u8,arg2: usize,arg3: *mut u8,arg4: usize,arg5: i32,arg6: i32,arg7: i32,arg8: *mut u8,arg9: usize,arg10: i32,) -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
    _rt::run_ctors_once();let result3 = {
      let len0 = arg2;
      let bytes0 = _rt::Vec::from_raw_parts(arg1.cast(), len0, len0);
      let len1 = arg4;
      let bytes1 = _rt::Vec::from_raw_parts(arg3.cast(), len1, len1);
      T::request_task(FrameBorrow::lift(arg0 as u32 as usize), super::super::super::super::ntx::runner::types::TaskMeta{
        ...
        *ptr4.add(3*::core::mem::size_of::<*const u8>()).cast::<u8>() = (match accepted5 { true => 1, false => 0 }) as u8;
        ...
        Err(e) => { {
          *ptr4.add(0).cast::<u8>() = (1i32) as u8;
          let super::super::super::super::ntx::runner::types::PfError{ kind:kind8, message:message8, } = e;
    ...
    #[doc(hidden)]
    #[allow(non_snake_case)]
    pub unsafe fn __post_return_request_task<T: Guest>(arg0: *mut u8,) { unsafe {
      let l0 = i32::from(*arg0.add(0).cast::<u8>());
      match l0 {
        0 => {
    ...
    #[doc(hidden)]
    #[allow(non_snake_case, unused_unsafe)]
    pub unsafe fn _export_emit_progress_cabi<T: Guest>(arg0: i32,arg1: *mut u8,arg2: usize,) { unsafe {#[cfg(target_arch="wasm32")]
    _rt::run_ctors_once();{
      let len0 = arg2;
      let bytes0 = _rt::Vec::from_raw_parts(arg1.cast(), len0, len0);
      T::emit_progress(FrameBorrow::lift(arg0 as u32 as usize), _rt::string_lift(bytes0))
    };
  } }
  #[doc(hidden)]
  #[allow(non_snake_case, unused_unsafe)]
  pub unsafe fn _export_fail_cabi<T: Guest>(arg0: i32,arg1: i32,arg2: *mut u8,arg3: usize,) { unsafe {#[cfg(target_arch="wasm32")]
  _rt::run_ctors_once();{
    let len0 = arg3;
    let bytes0 = _rt::Vec::from_raw_parts(arg2.cast(), len0, len0);
    T::fail(FrameBorrow::lift(arg0 as u32 as usize), super::super::super::super::ntx::runner::types::PfError{
...
_rt::run_ctors_once();{
  T::release(Frame::from_handle(arg0 as u32))
};
} }
pub trait Guest {
  type Frame: GuestFrame;
  /// Initialize a ProtocolFrame instance with the capabilities prepared by Core.
  #[allow(async_fn_in_trait)]
  fn init(ctx: ProtocolInitCtx,bootstrap: _rt::Vec::<TaskMeta>,) -> Result<Frame,PfError>;
  /// Borrow an action context from the scheduler via PF arbitration.
  #[allow(async_fn_in_trait)]
  fn claim(pf: FrameBorrow<'_>,) -> Result<Option<ActionCtx>,PfError>;
  /// Commit a finished action back to Core.
  #[allow(async_fn_in_trait)]
  fn commit(pf: FrameBorrow<'_>,outcome: ActionResult,) -> Result<(),PfError>;
  /// Persist per-user context blobs for crash recovery.
  #[allow(async_fn_in_trait)]
  fn store_user(pf: FrameBorrow<'_>,entry: UserStoreEntry,) -> Result<(),PfError>;
  /// Restore per-user context when Protocol rehydrates state.
  #[allow(async_fn_in_trait)]
  fn load_user(pf: FrameBorrow<'_>,user: UserId,) -> Option<UserStoreEntry>;
  /// Request the scheduler to enqueue new tasks derived from runtime feedback.
  #[allow(async_fn_in_trait)]
  fn request_task(pf: FrameBorrow<'_>,descriptor: TaskMeta,) -> Result<EnqueueResult,PfError>;
  /// Emit structured progress back to Core/Host observers.
  #[allow(async_fn_in_trait)]
  fn emit_progress(pf: FrameBorrow<'_>,payload_json: _rt::String,) -> ();
  /// Surface a protocol-level failure that requires Core intervention.
  #[allow(async_fn_in_trait)]
  fn fail(pf: FrameBorrow<'_>,err: PfError,) -> ();
  /// Release resources once the workflow completes.
  #[allow(async_fn_in_trait)]
  fn release(pf: Frame,) -> ();
}
pub trait GuestFrame: 'static {
...
macro_rules! __export_ntx_runner_protocol_frame_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

    #[unsafe(export_name = "ntx:runner/protocol-frame#init")]
    unsafe extern "C" fn export_init(arg0: *mut u8,arg1: usize,arg2: *mut u8,arg3: usize,arg4: *mut u8,arg5: usize,arg6: *mut u8,arg7: usize,arg8: i32,arg9: *mut u8,arg10: usize,) -> *mut u8 {
      unsafe { $($path_to_types)*::_export_init_cabi::<$ty>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10) }
    }
    #[unsafe(export_name = "cabi_post_ntx:runner/protocol-frame#init")]
    unsafe extern "C" fn _post_return_init(arg0: *mut u8,) {
      unsafe { $($path_to_types)*::__post_return_init::<$ty>(arg0) }
    }
    #[unsafe(export_name = "ntx:runner/protocol-frame#claim")]
    unsafe extern "C" fn export_claim(arg0: i32,) -> *mut u8 {
      unsafe { $($path_to_types)*::_export_claim_cabi::<$ty>(arg0) }
    }
    #[unsafe(export_name = "cabi_post_ntx:runner/protocol-frame#claim")]
    unsafe extern "C" fn _post_return_claim(arg0: *mut u8,) {
      unsafe { $($path_to_types)*::__post_return_claim::<$ty>(arg0) }
    }
    #[unsafe(export_name = "ntx:runner/protocol-frame#commit")]
    unsafe extern "C" fn export_commit(arg0: *mut u8,) -> *mut u8 {
      unsafe { $($path_to_types)*::_export_commit_cabi::<$ty>(arg0) }
    }
    #[unsafe(export_name = "cabi_post_ntx:runner/protocol-frame#commit")]
    unsafe extern "C" fn _post_return_commit(arg0: *mut u8,) {
      unsafe { $($path_to_types)*::__post_return_commit::<$ty>(arg0) }
    }
    #[unsafe(export_name = "ntx:runner/protocol-frame#store-user")]
    unsafe extern "C" fn export_store_user(arg0: i32,arg1: *mut u8,arg2: usize,arg3: *mut u8,arg4: usize,arg5: i64,) -> *mut u8 {
      unsafe { $($path_to_types)*::_export_store_user_cabi::<$ty>(arg0, arg1, arg2, arg3, arg4, arg5) }
    }
    #[unsafe(export_name = "cabi_post_ntx:runner/protocol-frame#store-user")]
    unsafe extern "C" fn _post_return_store_user(arg0: *mut u8,) {
      unsafe { $($path_to_types)*::__post_return_store_user::<$ty>(arg0) }
    }
    #[unsafe(export_name = "ntx:runner/protocol-frame#load-user")]
    unsafe extern "C" fn export_load_user(arg0: i32,arg1: *mut u8,arg2: usize,) -> *mut u8 {
      unsafe { $($path_to_types)*::_export_load_user_cabi::<$ty>(arg0, arg1, arg2) }
    }
    #[unsafe(export_name = "cabi_post_ntx:runner/protocol-frame#load-user")]
    unsafe extern "C" fn _post_return_load_user(arg0: *mut u8,) {
      unsafe { $($path_to_types)*::__post_return_load_user::<$ty>(arg0) }
    }
    #[unsafe(export_name = "ntx:runner/protocol-frame#request-task")]
    unsafe extern "C" fn export_request_task(arg0: i32,arg1: *mut u8,arg2: usize,arg3: *mut u8,arg4: usize,arg5: i32,arg6: i32,arg7: i32,arg8: *mut u8,arg9: usize,arg10: i32,) -> *mut u8 {
      unsafe { $($path_to_types)*::_export_request_task_cabi::<$ty>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10) }
    }
    #[unsafe(export_name = "cabi_post_ntx:runner/protocol-frame#request-task")]
    unsafe extern "C" fn _post_return_request_task(arg0: *mut u8,) {
      unsafe { $($path_to_types)*::__post_return_request_task::<$ty>(arg0) }
    }
    #[unsafe(export_name = "ntx:runner/protocol-frame#emit-progress")]
    unsafe extern "C" fn export_emit_progress(arg0: i32,arg1: *mut u8,arg2: usize,) {
      unsafe { $($path_to_types)*::_export_emit_progress_cabi::<$ty>(arg0, arg1, arg2) }
    }
    #[unsafe(export_name = "ntx:runner/protocol-frame#fail")]
    unsafe extern "C" fn export_fail(arg0: i32,arg1: i32,arg2: *mut u8,arg3: usize,) {
      unsafe { $($path_to_types)*::_export_fail_cabi::<$ty>(arg0, arg1, arg2, arg3) }
    }
    #[unsafe(export_name = "ntx:runner/protocol-frame#release")]
    ...
    const _: () = {
      #[doc(hidden)]
      #[unsafe(export_name = "ntx:runner/protocol-frame#[dtor]frame")]
      #[allow(non_snake_case)]
      unsafe extern "C" fn dtor(rep: *mut u8) {
        unsafe {
          $($path_to_types)*::Frame::dtor::<
          <$ty as $($path_to_types)*::Guest>::Frame
          >(rep)
        }
      }
    };
...
#[doc(hidden)]
pub(crate) use __export_ntx_runner_protocol_frame_cabi;
...
macro_rules! __export_protocol_frame_world_impl {
  ($ty:ident) => (self::export!($ty with_types_in self););
  ($ty:ident with_types_in $($path_to_types_root:tt)*) => (
  $($path_to_types_root)*::exports::ntx::runner::protocol_frame::__export_ntx_runner_protocol_frame_cabi!($ty with_types_in $($path_to_types_root)*::exports::ntx::runner::protocol_frame);
  )
}
#[doc(inline)]
pub(crate) use __export_protocol_frame_world_impl as export;

#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.48.0:ntx:runner:protocol-frame-world:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 2135] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xcc\x0f\x01A\x02\x01\
A\x0c\x01B3\x01s\x04\0\x07task-id\x03\0\0\x01s\x04\0\x07user-id\x03\0\x02\x01s\x04\
...
t-ctx\x02\x03\0\0\x09task-meta\x02\x03\0\0\x0aaction-ctx\x02\x03\0\0\x0daction-r\
esult\x02\x03\0\0\x0eenqueue-result\x02\x03\0\0\x08pf-error\x02\x03\0\0\x10user-\
store-entry\x02\x03\0\0\x07user-id\x01B,\x02\x03\x02\x01\x01\x04\0\x11protocol-i\
nit-ctx\x03\0\0\x02\x03\x02\x01\x02\x04\0\x09task-meta\x03\0\x02\x02\x03\x02\x01\
\x03\x04\0\x0aaction-ctx\x03\0\x04\x02\x03\x02\x01\x04\x04\0\x0daction-result\x03\
\0\x06\x02\x03\x02\x01\x05\x04\0\x0eenqueue-result\x03\0\x08\x02\x03\x02\x01\x06\
\x04\0\x08pf-error\x03\0\x0a\x02\x03\x02\x01\x07\x04\0\x10user-store-entry\x03\0\
\x0c\x02\x03\x02\x01\x08\x04\0\x07user-id\x03\0\x0e\x04\0\x05frame\x03\x01\x01p\x03\
\x01i\x10\x01j\x01\x12\x01\x0b\x01@\x02\x03ctx\x01\x09bootstrap\x11\0\x13\x04\0\x04\
init\x01\x14\x01h\x10\x01k\x05\x01j\x01\x16\x01\x0b\x01@\x01\x02pf\x15\0\x17\x04\
\0\x05claim\x01\x18\x01j\0\x01\x0b\x01@\x02\x02pf\x15\x07outcome\x07\0\x19\x04\0\
\x06commit\x01\x1a\x01@\x02\x02pf\x15\x05entry\x0d\0\x19\x04\0\x0astore-user\x01\
\x1b\x01k\x0d\x01@\x02\x02pf\x15\x04user\x0f\0\x1c\x04\0\x09load-user\x01\x1d\x01\
j\x01\x09\x01\x0b\x01@\x02\x02pf\x15\x0adescriptor\x03\0\x1e\x04\0\x0crequest-ta\
sk\x01\x1f\x01@\x02\x02pf\x15\x0cpayload-jsons\x01\0\x04\0\x0demit-progress\x01\x20\
\x01@\x02\x02pf\x15\x03err\x0b\x01\0\x04\0\x04fail\x01!\x01@\x01\x02pf\x12\x01\0\
\x04\0\x07release\x01\"\x04\0\x19ntx:runner/protocol-frame\x05\x09\x04\0\x1fntx:\
runner/protocol-frame-world\x04\0\x0b\x1a\x01\0\x14protocol-frame-world\x03\0\0\0\
G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.241.2\x10wit-bindge\
n-rust\x060.48.0";
