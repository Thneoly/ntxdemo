...
macro_rules! __export_core_runtime_impl {
...
#[doc(inline)]
pub(crate) use __export_core_runtime_impl as export;

#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.48.0:ntx:runner:core-runtime:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7188] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x917\x01A\x02\x01A6\x01\
...
ogress\x05%\x04\0\x17ntx:runner/core-runtime\x04\0\x0b\x12\x01\0\x0ccore-runtime\
\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.241.2\x10\
