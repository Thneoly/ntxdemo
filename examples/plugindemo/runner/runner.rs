...
macro_rules! __export_runner_impl {
  ...
  $($path_to_types_root)*::__export_world_runner_cabi!($ty with_types_in $($path_to_types_root)*);
  )
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.48.0:component:runner:runner:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1319] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xaa\x09\x01A\x02\x01\
A\x0a\x01B\x04\x04\0\x05error\x03\x01\x01h\0\x01@\x01\x04self\x01\0s\x04\0\x1d[m\
ethod]error.to-debug-string\x01\x02\x03\0\x13wasi:io/error@0.2.6\x05\0\x01B\x0a\x04\
...
poll@0.2.6\x05\x01\x02\x03\0\0\x05error\x02\x03\0\x01\x08pollable\x01B(\x02\x03\x02\
...
\x18\x03\0\x15wasi:io/streams@0.2.6\x05\x04\x01@\0\x01\0\x04\0\x05start\x01\x05\x04\
\0\x17component:runner/runner\x04\0\x0b\x0c\x01\0\x06runner\x03\0\0\0G\x09produc\
ers\x01\x0cprocessed-by\x02\x0dwit-component\x070.241.2\x10wit-bindgen-rust\x060\
.48.0";
